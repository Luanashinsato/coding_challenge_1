...
let employeeName = "Sophia Carter";
...
let isLoggedIn = true;
let isAdmin = true; 
let accessGranted = isLoggedIn && isAdmin;
console.log ("Access Granted:", accessGranted);
console.log ("Access Denied:", !accessGranted);
